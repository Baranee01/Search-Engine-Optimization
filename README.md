...
In a terminal or command window, navigate to the top-level project directory `Search-Engine-Optimization/` (that contains this README) and run one of the following commands:
